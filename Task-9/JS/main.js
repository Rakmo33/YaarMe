...
document.querySelector(".touch-swipe2").addEventListener("touchstart", startTouch, false);
document.querySelector(".touch-swipe").addEventListener("touchmove", moveTouch, false);
document.querySelector(".touch-swipe2").addEventListener("touchmove", moveTouch, false);
...
var targets = document.querySelectorAll('.stories-wrap')
...
var targets2 = document.querySelectorAll('.stories-wrap .card2')
